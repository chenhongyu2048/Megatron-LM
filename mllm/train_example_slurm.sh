...
#SBATCH --partition=gpu_h100            # Partition to submit to (adjust based on your cluster)
...
#SBATCH --time=00:05:00                 # Time limit for the job (Format: HH:MM:SS)
